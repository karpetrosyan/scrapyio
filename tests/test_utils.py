...
def test_object_loading():
    assert load_module("scrapyio.middlewares.BaseMiddleWare").__name__ == "BaseMiddleWare"
    assert load_module("scrapyio.downloader.BaseDownloader").__name__ == "BaseDownloader"
